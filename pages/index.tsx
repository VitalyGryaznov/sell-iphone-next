...
export default function Home() {
  return (
    <>
      <Head>
        <title>iPhone verkaufen</title>
        <meta name="description" content="Die besten Optionen ein gebrauchtes iPhone zu verkaufen im Jahr 2023" />
      ...
      <div className="article_container">
        <h1 className="article_header">
          Die besten Optionen ein gebrauchtes iPhone zu verkaufen im Jahr 2023
        </h1>
       
        <Image style={{width: '100%', height: 'auto'}}
    className="article_image"
    src="/iphone_verkaufen.jpeg"
